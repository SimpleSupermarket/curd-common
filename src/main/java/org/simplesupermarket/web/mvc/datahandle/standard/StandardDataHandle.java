package org.simplesupermarket.web.mvc.datahandle.standard;

import org.simplesupermarket.web.auth.AuthUserDetail;
import org.simplesupermarket.web.mvc.datahandle.CodeBuilder;
...
public class StandardDataHandle implements DataHandle {
    ...
    public <T> T handleData(T data, AuthUserDetail user) {
