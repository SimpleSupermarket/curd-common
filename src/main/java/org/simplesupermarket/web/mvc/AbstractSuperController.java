...
import org.simplesupermarket.web.mvc.controller.SearchData;
...
public abstract class AbstractSuperController<T> {
    ...
    @Autowired
    protected AbstractSuperService<T> service;
    ...
    public Boolean add(@RequestBody T data, UsernamePasswordAuthenticationToken user) {
        ...
        AuthUserDetail userDetail = (AuthUserDetail) user.getPrincipal();
