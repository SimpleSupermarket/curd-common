package org.simplesupermarket.web.mvc;


import org.simplesupermarket.web.annotation.FromDb;
import org.simplesupermarket.web.mvc.datahandle.DataHandle;
import org.simplesupermarket.web.annotation.ViewClass;
import org.simplesupermarket.web.mvc.datahandle.standard.StandardDataHandle;
...
public abstract class AbstractSuperService<T> {
    ...
    public Boolean add(T data, AuthUserDetail userDetail) {
